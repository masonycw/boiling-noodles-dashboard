...
-- 修正：erp_stocktake_groups 須在 erp_items FK 建立前先建立
-- ════════════════════════════════════════════════════════════════════

BEGIN;

-- ─────────────────────────────────────────────
-- 1. ENUM Types（須在使用前建立）
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- 2. 先建立被 FK 引用的新表（erp_stocktake_groups）
-- ─────────────────────────────────────────────
...
-- 3C. erp_items：新增盤點群組 / 顯示順序 / 第二單位（FK 現在已可引用）
...
-- ════════════════════════════════════════════════════════════════════
-- 執行方式：psql postgresql://dashboard_user:noodles2026@localhost/boiling_noodles -f erp/backend/db/migrate_phase3.sql
-- ════════════════════════════════════════════════════════════════════
